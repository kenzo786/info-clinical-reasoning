...
| Coagulation disorders (including haemophilia, Von Willebrand disease, and thrombophilia, and secondary to illness or medication) | Blood and lymph | missing | medium | phase-3-create-backlog |  | is-coagulation-disorders-including-haemophilia-von-willebrand-disease-and-thrombophilia-and-secondary-to-illness-or-medication.html | no-final-file-yet | create-new | not-started |  |
...
| Huntington disease | Genetic and congenital | covered-needs-refresh | medium | phase-2-refresh | is-huntingtons-disease | is-huntington-disease.html | legacy-source-only | refresh-existing | not-started | Legacy/archive source scripts exist in gap tracker. |
...
| Condition | Category | Gap tracker status | Priority | Phase | Matched scripts | Canonical final target | Current final file status | Next action | Review status | Notes |
|---|---|---|---|---|---|---|---|---|---|---|
| Bone tumours (primary and secondary including osteosarcoma, Ewing sarcoma) | Musculoskeletal | missing | medium | phase-3-create-backlog |  | is-bone-tumours-primary-and-secondary-including-osteosarcoma-ewing-sarcoma.html | no-final-file-yet | create-new | not-started |  |
